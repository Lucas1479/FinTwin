...
const CashFlowSchema = new mongoose.Schema(
  {
    ...
    // ==========================================
    // Passive Income Tracking (NEW)
    // Links this CashFlow to a FinancialAsset (e.g., Term Deposit interest)
    // ==========================================
    source_asset_id: {
      type: mongoose.Schema.Types.ObjectId,
      ref: 'FinancialAsset',
      required: false,
      index: true,
      description: "If set, this income is generated by a linked asset (e.g., bank interest)"
    },
    
    // Is this a system-generated passive income? (vs user-created)
    is_passive_income: {
      type: Boolean,
      default: false,
      description: "True if auto-generated from asset interest_rate"
    },
